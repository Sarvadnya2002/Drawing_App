...
class MainActivity : AppCompatActivity() {
    ...
    //Todo: Instead of dialog box, we can use progress picker like volume key
    ...
    private fun requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            showRationaleDialog(
                "Kids Drawing App",
                "Background image cannot be used because External Storage access is denied"
            )
        } else {
            requestPermissions.launch(
                ...
                //todo : Add writing external permissions here
            )
        }
    }
    ...
    //Todo : USe for other projects also
